...
const TEACHERS = [
  ...
  { spec:'hifz',         img:'/images/teachers/teacher-4.png', name:'Qaria Amna',   title:'Hifz · Memorization',              origin:'Egypt',        flag:'🇪🇬', exp:'10 yrs', rating:'4.9', reviews:'175', langs:['Arabic','English'], tags:['Hifz','Ijazah'],           rate:'$14/hr', back:'Completed his own Hifz at age 12. Runs a structured Hifz programme with smart spaced repetition and weekly milestone reviews.' },
  { spec:'tajweed kids', img:'/images/teachers/teacher-5.png', name:'Maryam Noor',    title:'Tajweed for All Ages',             origin:'United Kingdom',flag:'🇬🇧', exp:'6 yrs',  rating:'4.7', reviews:'83',  langs:['English','Urdu'],    tags:['Tajweed','Kids'],          rate:'$11/hr', back:'Based in the UK, understands the challenges Western-born Muslims face with Arabic. Makes Tajweed accessible and relatable for all ages.' },
  { spec:'tafseer hifz', img:'/images/teachers/teacher-6.png', name:'Hafiza Ayesha',   title:'Tafseer & Hifz Programme',         origin:'Saudi Arabia', flag:'🇸🇦', exp:'20 yrs', rating:'4.9', reviews:'321', langs:['Arabic','Urdu'],    tags:['Scholar','Advanced'],      rate:'$18/hr', back:'20 years of teaching experience. Holds multiple Ijazahs and has taught students who have gone on to become Huffaz and scholars themselves.' },
]
